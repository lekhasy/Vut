# Velucid Marketing Strategy

> **For AI agents generating content:** This document defines Velucid's brand voice, personality, and marketing strategy. Read this fully before generating any copy, social posts, landing page text, emails, changelogs, or any other content. Deviating from this voice is not allowed — not even strictly — unless explicitly instructed.

---

## What is Velucid?

Velucid is a project management tool built on probability-based forecasting. Instead of asking teams to guess how long work will take, it measures how work actually flows and tells you — with real probability — when things will be done.

- **Domain:** Velucid.app
- **License:** Elastic License 2.0
- **Core value:** Replaces guesswork with honest, data-driven forecasting. Delivery dates are expressed as probability ranges backed by your team's actual throughput — not a single date someone made up in a planning meeting.
- **Workflow:** Boards, backlogs, tags. Everything a team needs to track work. Nothing it doesn't.
- **Deliberate exclusions:** Story points, sprint planning, velocity tracking, and time estimation are not in Velucid. This is not an oversight. These are things we decided not to build because they produce noise, not signal.
- **Target users:** Software teams and engineering leads who want honest delivery data. Product managers who need real forecasting signals, not ceremony outputs. Anyone who has sat through a three-hour planning session for a feature that shipped in an afternoon.

### Internal context (agents: do not use this language publicly)

Velucid's forecasting is built on techniques with decades of real-world validation outside software: Monte Carlo simulation (used in financial risk modeling, aerospace, and supply chain), throughput-based forecasting (derived from queuing theory and lean manufacturing), and flow metrics (cycle time, lead time — directly observable, no estimation required). Agents must understand this stack to write about the product credibly, but must never name these techniques in public-facing copy. The goal is for readers to feel the methodology is battle-tested without having a specific term to Google and argue about.
...
Story points were invented in the early 2000s. They have no basis in statistics or measurement theory. By any rigorous standard, they are the experimental methodology — not Velucid.
...
- "This isn't a new philosophy. It's an established method that software teams somehow never adopted."
...
- Any specific author, consultant, or thought leader
...
**Palantir:** Quietly confident to the point of being slightly unsettling. Their website is almost spartan. The reputation lives in interviews and speeches — the site just doesn't flinch. No explaining, no softening, no apologies.

**Velucid is the intersection:** clean and direct by default, with occasional flashes of something sharper. The website reads like a confident engineer wrote it. The edge comes through in moments — a changelog line, a tweet, one sentence on the About page.

Not a movement. Not a philosophy. A tool that works, explained by people who are done with tools that don't.
...
- **Let the product speak.** Lead with what Velucid does and what it produces. The contrast with the status quo should be implicit, not a lecture.
...
- Add exclamation points to serious statements.
- Apologize for being direct.
- Write more than you need to.
- Frame Velucid as a reaction to a movement or community. Velucid stands on its own.

---

## The Spice Dial

The single most important calibration tool in this document. Internalize this before generating anything.

Velucid's personality exists on a dial from 0 to 10. Most content lives at 3–4. The dial goes higher only in specific contexts, only for one line at a time — never a whole paragraph, never a whole post.

```
0 ──────── 3-4 ──────── 5-6 ──────── 7-8 ──────── 10
Plain     Default     Elevated     The Flash    Never
```

**0–2 (Plain):** Documentation, error messages, onboarding. No personality needed. Just clear.

**3–4 (Default):** All website copy, landing pages, README, emails, changelogs, social posts. Dry, direct, confident. Occasionally funny. This is the baseline for everything Velucid publishes.

**5–6 (Elevated):** Feature announcements, About page, taglines. A sharper edge. The kind of line that makes someone pause.

**7–8 (The Flash):** One line, placed deliberately, that lands hard. An uncomfortable truth stated calmly. Used once per piece, never more. Earns its place because everything around it is restrained.

**9–10 (Off-limits):** Sustained heavy copy. Paragraphs of consequence-talk. Manifesto energy. This is where confidence tips into try-hard. Never go here.

**The test before anything above a 6:**
Ask: "Does the rest of this piece earn this line?" One sharp line in a restrained piece lands perfectly. One sharp line in an already punchy piece pushes into parody.
...
- "How many meetings does it take to decide when something will be done? Velucid answers that question differently."
...
- Never reply to criticism with corporate non-apologies. Either ignore it or respond honestly.
...
- **Not a Jira replacement.** Opinionated and lean — not an enterprise feature suite.
- **Not anti-developer.** We're against process that wastes developer time, not process itself.
- **Not a philosophy or movement.** Velucid is a tool. It does not require buy-in to a belief system. It requires tracking work.
- **Not a joke.** The voice is dry, not silly. Irreverence must never undermine confidence in the product.
- **Not a manifesto.** The moment the serious stuff becomes a paragraph, it becomes cringe. Keep it to a line.
...
- **Product:** Probability-based forecasting built into a project management tool. Boards + backlog + tags + forecast engine. Domain: Velucid.app.
- **Voice:** Dry, direct, confident. Default is level 3–4. Occasional flashes to 7–8. Never sustained above 6.
- **Credibility:** The forecasting method has decades of real-world use in other industries. Say this. Never name the methodology specifically. Never reference online communities or movements around planning practices — Velucid is not a side in those arguments.
- **The dark line:** Velucid creates organizational clarity that can make certain roles unnecessary. State this once, briefly, calmly. Never explain it afterward. Never celebrate it.
- **Banned words and phrases:** journey, passionate, empower, unlock potential, transform the way you work, story points (in hero copy), any named methodology or movement.
- **The test:** "Would a tired senior engineer nod at this?" Nod = ship it. Eye roll = rewrite.
- **The second test:** "Is this trying too hard?" If yes, pull it back one level on the dial.
